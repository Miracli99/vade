...
export const styles = StyleSheet.create({
  ...
  editorModalBackdrop: {
    flex: 1,
    backgroundColor: "rgba(3, 6, 14, 0.82)",
    justifyContent: "center",
    paddingHorizontal: 18,
    paddingVertical: 24,
  },
  editorModalWrap: {
    ...
    ...Platform.select({
      web: {
        boxShadow: "0px 26px 70px rgba(0, 0, 0, 0.42)",
      } as object,
      default: {
        shadowColor: "#000",
        shadowOpacity: 0.38,
  ...
  editorCardDisclosureOpen: {
    backgroundColor: "rgba(251, 191, 36, 0.22)",
  },
  editorCardDisclosureLabel: {
    color: "#f8fafc",
    fontSize: 17,
    fontWeight: "900",
    lineHeight: 20,
  },
  editorCardSummaryText: {
    flex: 1,
    minWidth: 0,
    gap: 3,
  },
